...
float convertRawToPhScale(uint16_t rawValue) {
    // Conversão otimizada de valor bruto para escala de pH (0-14)
    return (static_cast<float>(rawValue) * PH_SCALE_MAX) / 4095.0f;
}
